[{
  ...
  stages: [
    ...
    },
    {
      ...
      indexesUsed: [],
      nReturned: Long("260"),
      executionTimeMillisEstimate: Long("482")
    },
    {
      '$group': {
    ...
    },
    {
      ...
      indexesUsed: [],
      nReturned: Long("486"),
      executionTimeMillisEstimate: Long("483")
    },
    {
      '$project': {
        _id: true,
    ...
    },
    {
      '$project': {
        ...
        createDate: { '$const': ISODate("2021-12-23T04:32:41.821Z") },
        _id: { '$const': ObjectId("61c3fbe98458a244fc204449") }
      },
      nReturned: Long("1"),
      executionTimeMillisEstimate: Long("483")
    },
    ...
    pipeline: [
      ...
      },
      {
        '$project': {
          ...
          createDate: ISODate("2021-12-23T04:32:41.821Z"),
          _id: ObjectId("61c3fbe98458a244fc204449")
        }
      },
      { '$merge': 'Revenue' }
    ],
